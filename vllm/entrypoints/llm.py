...
class LLM(BeamSearchOfflineMixin, PoolingOfflineMixin, OfflineInferenceMixin):
    ...
    def __init__(
        ...
        *,
        ...
        moe_expert_host_cache_size: int = 0,
        moe_expert_storage_prefetch_budget_mb: float = 0,
        moe_expert_storage_max_inflight_mb: float = 0,
        moe_expert_storage_workers: int = 4,
        ...
        **kwargs: Any,
        ...
        engine_args = EngineArgs(
            ...
            moe_expert_storage_path=moe_expert_storage_path,
            moe_expert_host_cache_size=moe_expert_host_cache_size,
            moe_expert_storage_prefetch_budget_mb=(
                moe_expert_storage_prefetch_budget_mb
            ),
            moe_expert_storage_max_inflight_mb=(moe_expert_storage_max_inflight_mb),
            moe_expert_storage_workers=moe_expert_storage_workers,
